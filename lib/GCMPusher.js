...
var push = function (tokens, message,infoApp) {
    gcmSender(infoApp).send(message, tokens, 4, function (err, res) {
...
var gcmSender = _.once(function(infoApp) {
    return new gcm.Sender(infoApp.gcm);
});
