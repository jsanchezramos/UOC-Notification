...
var updateGCM = function (fromToArray) {
    fromToArray.forEach(function (gcmUpdate) {
        AppIdAcces.findOneAndUpdate({appId: gcmUpdate.appId}, {gcm: gcmUpdate.key}, function (err) {
            if (err) console.error(err);
        });
    });
};

var updateAPN = function (fromToArray) {
    fromToArray.forEach(function (apnUpdate) {
